...
def data():
    ...
    data = {
    "alt_baro": [34000, 36000, 32000, 1800, 28000, 38000, 37925, 11400, 3450, 45000],
    "gs": [445.2, 443.5, 426.7, 90.2, 461.2, 416.9, 433.2, 187.4, 75.9, 473.1],
    "track": [268.46, 272.84, 237.54, 54.02, 247.16, 250.09, 278.90, 45.65, 108.43, 102.45],
    "baro_rate": [0.0, 0.0, 0.0, None, 64.0, 0.0, 0.0, 1408.0, None, 0.0],
    "lat": [28.821808, 28.638890, 29.966354, 30.427551, 29.769928, 29.946496, 28.797958, 30.687747, 30.158752, 29.076920],
    "lon": [-91.527152, -91.345933, -91.177153, -91.151733, -91.056906, -90.934497, -90.922218, -90.903680, -90.790369, -90.753250],
    "category": ["A3", "A3", "A3", "A1", "A3", "A3", "A3", "A1", "A1", "A2"],
    "t": ["B38M", "B38M", "A321", "P28A", "A321", "B38M", "A20N", "PC12", "C172", "GLF4"],
    "flight": ["UAL1929", "AAL1637", "DAL919", "N81149", "AAL2927", "SWA2992", "NKS3168", "SKQ37", "N346SP", "N43XT"],
    "timestamp": [
